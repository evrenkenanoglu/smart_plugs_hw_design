...
2.  **Protection:**
    ...
    *   **NTC (`NTC1`):** `10D-7` (10Ω). Limits inrush current to protect the Fuse/PSU.
...
1.  **5V Rail:** Filtered by **220µF Electrolytic** (Bulk) + **100nF Ceramic** (HF Noise).
2.  **3.3V Rail:** Generated by **AMS1117-3.3** LDO. Filtered by 220µF + 100nF.
...
*   **Indication:** LED + 470Ω Resistor in parallel with coil.
