...
class PowerAnalyzer:
    ...
    def analyze_dc_loads(self):
        ...
        self.design_load_psu = self.total_dc_ma * (1 + self.sys['safety_margin_percent']/100)
        return dc_rows
    ...
    def get_ac_requirements(self):
        ...
        return IPCCalculator.calculate_ac_input(
            dc_watts, 
            self.psu.get('efficiency', 0.7), 
            self.sys['mains_voltage_ac_v']
        )
    ...
    def build_width_targets(self, ac_amps):
        ...
        design_load_3v3 = self.rail_3v3_ma * (1 + self.sys['safety_margin_percent']/100)
